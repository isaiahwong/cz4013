...
# Generic Codec interface for encoding and decoding during marshalling/unmarshalling


class Encoder:
    """
    Encoder class to encode values of different types
    """
    ...
    def write_bool(self, b: bool):
        ...
        # < means little-endian ? means 1 byte (char)
    ...
    def write_int64(self, i: int):
        ...
        self.out.extend(struct.pack("<q", int(i)))
...
class DictCodec(Codec):
    ...
    Assumes only homogeneous key value pairs
    """
